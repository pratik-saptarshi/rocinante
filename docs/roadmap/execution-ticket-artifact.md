...
- In progress features: `F-031`, `F-016`, `F-017`, `F-023` (4)
- New backlog: `F-018` … `F-022`, `F-024` … `F-027`, `F-033` (10)
...
2. **Stream B — Trust/Identity + Sanitization**
   ...
   - Exit gate: `T-010`, `T-011`, `T-024`, `T-020`, `T-022`, auth no-side-effect verification.
